...
export enum CodeGenerationModel {
  ...
  CLAUDE_4_5_OPUS_2025_09_29 = "claude-opus-4-5-20250929",
...
export const CODE_GENERATION_MODEL_DESCRIPTIONS: {
  ...
  "claude-opus-4-5-20250929": { name: "Claude Opus 4.5", inBeta: false },
  "claude-sonnet-4-5-20250929": { name: "Claude Sonnet 4.5", inBeta: false },
  "gemini-3.0-pro": { name: "Gemini 3 Pro", inBeta: false },
